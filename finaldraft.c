...
// Hashdefined maximum laptops

#define MAX_LAPTOPS 41

// Hashdefined maximum headphones 

#define MAX_HEADPHONES 120

// Hashdefined maximum smartphones

#define MAX_SMARTPHONES 50

// Hashdefined carth size

#define CART_SIZE 100

// Hashdefined card details 

#define MAX_CARD_DETAILS_LENGTH 100

// Hashdefined file name
...
printf("      ##            STOP TO SHOP             ## \n");
printf("      ##                                     ##\n");
printf("      ##  choose the device you want to have ##\n");
printf("      ##                                     ##\n");
printf("      ##   1)SMART PHONES                    ##\n");
printf("      ##   2)LAPTOPS                         ##\n");
printf("      ##    3)TABS                           ##\n");
printf("      ##   4)HEADPHONES                      ##\n");
printf("      ##                                     ##\n");
...
// Function to display the message after checkout
...
laptopdiagram();
    ...
    // asking the user to input choice of laptop
